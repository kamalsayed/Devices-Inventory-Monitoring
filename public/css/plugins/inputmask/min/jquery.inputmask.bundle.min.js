      ...
      function maskScope (actionObj, maskset, opts) {
        ...
        function getTests (pos, ndxIntlzr, tstPs) {
          ...
          function resolveTestFromToken (
            ...
            function handleMatch (match, loopNdx, quantifierRecurse) {
              ...
              if (testPos === pos && match.matches === undefined) {
                ...
                if (match.isGroup && quantifierRecurse !== match) {
                  ...
                  var qt = match;
                  for (
                    var qndx = ndxInitializer.length > 0
                      ? ndxInitializer.shift ()
                      : 0;
                    qndx <
            ...
            for (
              var tndx = ndxInitializer.length > 0
                ? ndxInitializer.shift ()
                : 0;
        ...
        function alternate (pos, c, strict, fromSetValid, rAltPos) {
          ...
          if (alternation !== undefined) {
            ...
            getMaskSet ().excludes[decisionPos] = getMaskSet ().excludes[
              decisionPos
            ] || [];
            if (pos !== true) {
        ...
        function seekPrevious (pos, newBlock) {
          ...
          while (
            ...
            ((newBlock === true &&
              ...
              (newBlock !== true &&
                !isMask (position) &&
                ((tests = getTests (position)), tests.length < 2 ||
        ...
        var EventRuler = {
          on: function on (input, eventName, eventHandler) {
            ...
            input.inputmask.events[eventName] = input.inputmask.events[
              eventName
            ] || [];
        ...
        function initializeColorMask (input) {
          var computedStyle = (input.ownerDocument.defaultView || window)
            .getComputedStyle (input, null);
        ...
        numeric: {
          ...
          onBeforeMask: function onBeforeMask (initialValue, opts) {
            ...
            var valueParts = initialValue.split (radixPoint),
              ...
              decimalPart = valueParts.length > 1
