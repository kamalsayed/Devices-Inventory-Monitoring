        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title" >أجهزة الحاسب</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
        ...
        $(document).on('click','#addpc', function(){
                ...
                if(computer_brand !='' && working !='' && serial !='' && place !=''){
                    $.ajax({
                        ...
                        method:'post',
                        data:{computer_brand:computer_brand,working:working,serial:serial,place:place,notes:notes,_token: CSRF_TOKEN},
         ...
         $.ajax({
                 ...
                 success:function(data){
                    ...
                    html+='<td contenteditable class="column_name" data-column_name="working" data-id="'+data[i].id+'">يعمل</td>';
                       ...
                       html+='<td contenteditable class="column_name" data-column_name="notes"  data-id="'+data[i].id+'">'+data[i].notes+'</td>';
